           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=produk"><i class="fa fa-bitbucket fa-3x"></i>Produk</a></li>
                    <li><a href="index.php?halaman=pembelian"><i class="fa fa-th-list fa-3x"></i>Pembelian</a></li>
                    <li><a href="index.php?halaman=pelanggan"><i class="fa fa-desktop fa-3x"></i>Pelanggan</a></li>
                    <li><a href="index.php?halaman=logout"><i class="fa fa-close fa-3x"></i>Logout</a></li>
                </ul>
